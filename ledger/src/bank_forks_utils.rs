use {
    ...
    solana_sdk::{clock::Slot, genesis_config::GenesisConfig, pubkey::Pubkey},
...
pub fn load_debug(
    ...
    if let Some(snapshot_config) = snapshot_config {
        ...
        .is_some()
        {
            return load_from_snapshot_debug(
                genesis_config,
                blockstore,
                account_paths,
                shrink_paths,
...
fn load_from_snapshot_debug(
    ...
    let (deserialized_bank, timings, full_snapshot_archive_info, incremental_snapshot_archive_info) =
        snapshot_utils::bank_from_latest_snapshot_archives_debug(
            ...
            process_options.shrink_ratio,
            process_options.accounts_db_test_hash_calculation,
            true, // Set accounts_db_skip_shrink to true
            process_options.verify_index,
            process_options.accounts_db_config.clone(),
            accounts_update_notifier,
            faucet_pubkey,
